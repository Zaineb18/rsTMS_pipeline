...
def load_trimmeddata(SOURCE_PATH, subj, ses):
    RFUNC_PATH = glob.glob(os.path.join(SOURCE_PATH, f'sub-{subj}', f'ses-{ses}', 'func', f'sub-{subj:02}_ses-{ses}*_acq-trimmed*_bold.nii*'))
    RFMAP_PATH = glob.glob(os.path.join(SOURCE_PATH, f'sub-{subj}', f'ses-{ses}', 'fmap', f'sub-{subj:02}_ses-{ses}*_acq-trimmed*_epi.nii*'))
    return(RFUNC_PATH, RFMAP_PATH)
